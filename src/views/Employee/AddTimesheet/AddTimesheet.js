      ...
      <div>
        <Card>
          ...
          <CardBody>
            <Row>
              <FormGroup>
                <Label><strong>Todays's date:&nbsp;</strong></Label>
                <Input type="text" value={this.state.curdate} name="ccyear" id="ccyear" onChange={this.handleChange}>
                </Input>
              </FormGroup>
            </Row>
            ...
            {this.state.rows.map((item, idx) => (
              <Container key={idx}>
                <Row>
                  ...
                  <Col xs="12" md="4" sm="6">
                    <button className="btn btn-danger" onClick={this.handleRemoveSpecificRow(idx)}>Remove</button>
